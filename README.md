...
* __Sistema de Login__: Cadastro de novos usuários e autenticação segura.

* __Upload de Imagens__: Usuários logados podem enviar fotos para a plataforma.

* __Mural Dinâmico__: Exibição das fotos postadas em um layout responsivo.

* __Perfis de Usuário__: Página personalizada mostrando as fotos de cada autor.
