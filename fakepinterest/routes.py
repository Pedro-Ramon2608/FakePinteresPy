...
from fakepinterest.forms import FormCriarConta, FormLogin, FormFotos
from fakepinterest.models import Usuario, load_usuario, Foto
import os
...
def perfil(id_usuario):
    if int(id_usuario) == int(current_user.id):
        ...
        # usuário está vendo o perfil de outra pessoa
